angular.module('freedomsworn')
	...
	.directive('cardLogo', ['$rootScope', function($rootScope){
		return {
			restrict: 'A',
			templateUrl: 'client/card/views/card-logo.ng.html'
		};
	}])
	.directive('cardHeader', function(){
		return {
			restrict: 'A',
			templateUrl: 'client/card/views/card-header.ng.html'
		};
	})
	.directive('cardDescription', function(){
		return {
			restrict: 'A',
			templateUrl: 'client/card/views/card-description.ng.html'
		};
	})
	.directive('cardModifiers', function(){
		return {
			restrict: 'A',
			templateUrl: 'client/card/views/card-modifiers.ng.html'
		};
	})
	.directive('cardBenefit', function(){
		return {
			restrict: 'A',
			templateUrl: 'client/card/views/card-benefit.ng.html'
		};
	})
	.directive('cardFooter', function(){
		return {
			restrict: 'A',
			templateUrl: 'client/card/views/card-footer.ng.html'
		};
	})
	.directive('cardAction', ['DataSRVC', function(DataSRVC){
		return {
			restrict: 'A',
			templateUrl: 'client/card/views/card-action.ng.html',
			scope: {
				cardAction: '=', panel: '='
			},
	...
	.directive('cardActionIcon', function(){
		return {
			restrict: 'A',
			templateUrl: 'client/card/views/card-action-icon.ng.html'
		};
	})
	.directive('cardActionTitle', function(){
		return {
			restrict: 'A',
			templateUrl: 'client/card/views/card-action-title.ng.html'
		};
	})
	.directive('cardActionKeywords', function(){
		return {
			restrict: 'A',
			templateUrl: 'client/card/views/card-action-keywords.ng.html'
		};
	})
	.directive('cardActionPrompt', function(){
		return {
			restrict: 'A',
			templateUrl: 'client/card/views/card-action-prompt.ng.html'
		};
	})
	.directive('cardActionEffect', function(){
		return {
			restrict: 'A',
			templateUrl: 'client/card/views/card-action-effect.ng.html'
		};
	})
	.directive('cardActionAttack', function(){
		return {
			restrict: 'A',
			templateUrl: 'client/card/views/card-action-attack.ng.html'
		};
	})
	.directive('cardActionDefense', function(){
		return {
			restrict: 'A',
			templateUrl: 'client/card/views/card-action-defense.ng.html'
		};
	})
